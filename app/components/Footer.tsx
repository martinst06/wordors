      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-zinc-400">AI-powered writing for everyone.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/#features" className="text-zinc-400 transition-colors hover:text-white">
                  Features
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/support" className="text-zinc-400 transition-colors hover:text-white">
                  FAQ
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/careers" className="text-zinc-400 transition-colors hover:text-white">
                  Careers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/security" className="text-zinc-400 transition-colors hover:text-white">
                  Security
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-zinc-800 pt-8 md:flex-row">
          <p className="text-sm text-zinc-500">© 2025 Wordors. All rights reserved.</p>
          <div className="flex gap-6">
            <a
              href="https://twitter.com"
              className="text-zinc-400 transition-colors hover:text-white"
              aria-label="Wordors on X"
            >
            ...
            <a
              ...
              className="text-zinc-400 transition-colors hover:text-white"
              aria-label="Wordors on Dribbble"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fillRule="evenodd"
